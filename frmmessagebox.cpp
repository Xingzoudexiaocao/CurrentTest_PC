    ...
    ui(new Ui::frmMessageBox)
{
    ...
    //设置图形字体
//    ui->btnMenu_Close->setObjectName("btnMenu_Close");
...
{
    if (type == 0) {
        ui->labIcoMain->setStyleSheet("border-image: url(:/Information/info.png);");
        ui->btnCancel->setVisible(false);
        ui->lab_Title->setText("成功");
    } else if (type == 1) {
        ui->labIcoMain->setStyleSheet("border-image: url(:/Information/question.png);");
        ui->btnCancel->setVisible(false);       // 询问窗作为提示窗
        ui->lab_Title->setText("提示");
    } else if (type == 2) {
        ui->labIcoMain->setStyleSheet("border-image: url(:/Information/error.png);");
        ui->btnCancel->setVisible(false);
